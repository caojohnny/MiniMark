...
public final class StructBenchmark_searchList {
    ...
    public Collection<? extends Result> searchList_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                ...
                l_blackhole1_0.consume(l_structbenchmark0_G.searchList());
            ...
            searchList_thrpt_jmhLoop(control, res, l_structbenchmark0_G, l_blackhole1_0);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "searchList", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void searchList_thrpt_jmhLoop(InfraControl control, RawResults result, StructBenchmark_1_jmh l_structbenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> searchList_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            StructBenchmark_1_jmh l_structbenchmark0_G = _jmh_tryInit_f_structbenchmark0_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            searchList_avgt_jmhLoop(control, res, l_structbenchmark0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    while(!StructBenchmark_1_jmh.setupInvocationMutexUpdater.compareAndSet(l_structbenchmark0_G, 0, 1)) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "searchList", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void searchList_avgt_jmhLoop(InfraControl control, RawResults result, StructBenchmark_1_jmh l_structbenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> searchList_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            StructBenchmark_1_jmh l_structbenchmark0_G = _jmh_tryInit_f_structbenchmark0_G(control, threadParams);
            ...
            searchList_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), l_structbenchmark0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    while(!StructBenchmark_1_jmh.setupInvocationMutexUpdater.compareAndSet(l_structbenchmark0_G, 0, 1)) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "searchList", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void searchList_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, StructBenchmark_1_jmh l_structbenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> searchList_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            StructBenchmark_1_jmh l_structbenchmark0_G = _jmh_tryInit_f_structbenchmark0_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            searchList_ss_jmhStub(control, res, l_structbenchmark0_G, l_blackhole1_0);
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SingleShotResult(ResultRole.PRIMARY, "searchList", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void searchList_ss_jmhStub(InfraControl control, RawResults result, StructBenchmark_1_jmh l_structbenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
